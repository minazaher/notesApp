...
import com.example.notesapp.dao.CredentialCategoryDao;
...
public abstract class NotesDatabase extends RoomDatabase {
    ...
    public static RoomDatabase.Callback myCallback = new Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            new Thread(() -> {
                ...
                CredentialCategoryDao credentialCategoryDao = notesDatabase.credentialCategoryDao();
            });
        }
    };
    ...
    static final Migration MIGRATION_9_10 = new Migration(10, 11) {
        @Override
        public void migrate(SupportSQLiteDatabase database) {
            database.execSQL(
                    "CREATE TABLE credential_category (no_of_apps INTEGER NOT NULL, " +
                            "category_name TEXT NOT NULL PRIMARY KEY DEFAULT 'Others')");

            database.execSQL(
                    "CREATE TABLE credential_new (id INTEGER PRIMARY KEY NOT NULL, " +
                            "email TEXT, category_name TEXT DEFAULT 'Others', password TEXT, appName TEXT, icon INTEGER NOT NULL," +
